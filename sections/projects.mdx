...
The following example adds two projects to the section, taken from the theme's example site:
  ...
  projects:
    ...
    items:
      ...
      - title: Image Converter
        content: A web app to convert image to pdf, png to jpg, and png to webp without a database using Django.
