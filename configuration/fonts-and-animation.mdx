...
<Warning>
Content in `customScripts` is rendered as raw HTML. Make sure `markup.goldmark.renderer.unsafe` is set to `true` in your `hugo.yaml`, otherwise Hugo may strip or escape the script tags in certain rendering contexts.
</Warning>
